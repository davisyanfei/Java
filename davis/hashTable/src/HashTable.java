...
public class HashTable {
 ...
 /*   public int hash2(String key){
    ...
    public static void main(String[] args) {
        ...
        hashTable.insert(new Info("ca","111"));
        hashTable.insert(new Info("tc","222"));
        hashTable.insert(new Info("cba","333"));

        System.out.println("a的hashcode的值="+hashTable.hashCode("a"));
        System.out.println("tc的hashcode的值="+hashTable.hashCode("tc"));
/*        int i;
        for (i=0;i<100;i++ ){
            System.out.println("数组["+i+"]的值是"+hashTable.arrays[i]);
        }*/


        System.out.println(hashTable.find("ca").getValue());
